...
ActiveAdmin.register Tag do
  ...
  sidebar :sample_attributes, only: :index, class: "test_class_attribute" do
    panel "Test", class: "p-0" do
  ...
  sidebar :sample_attributes2, only: :show, class: "mt-4" do
    attributes_table_for Tag.last do
      row :name
      row :created_at
      row :updated_at
  ...
  sidebar :sample_attributes3, only: :show, class: "mt-4" do
    attributes_table do
      row :name
      row :created_at
      row :updated_at
